...
<footer className=" dark:bg-gray-900" style={{background:"#EAF2AE"}}>
  <div className="waves">
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div className="lg:flex lg:items-start lg:gap-8">
      ...
      <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
        <div className="col-span-2">
          <div>
            <h2 className="text-2xl font-bold  dark:text-white" style={{color:"#393D40"}}>Get the latest news!</h2>
        ...
        <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
          <form className="w-full">
            ...
            >
             ...
             style={{background:"#EAF2AE"}} />

              <button
                className="mt-1 w-full  px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:shrink-0"
    ...
    <div className="mt-8 border-t  pt-8 dark:border-gray-800" style={{borderColor:"#393D40"}}>
