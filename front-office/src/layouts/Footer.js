  ...
  <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
    <div className="lg:flex lg:items-start lg:gap-8">
      ...
      <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
          ...
          <form className="w-full">
            ...
            >
             ...
             style={{background:"#B8D941",}} />
              ...
              <button
                className="mt-1 w-full  px-6 py-3 text-sm font-bold uppercase tracking-wide  transition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:shrink-0"
       ...
       <div className='flex justify-between w-full mb-4 col-span-5'>
       ...
       <ul className="flex gap-6 ">
        ...
        {/* <div className="col-span-2 sm:col-span-1">
          ...
          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <a href="#" className="text-gray-100 transition hover:opacity-75 dark:text-gray-200">
                Contact
              </a>
            </li>
