      ...
      <div className="first-section bg-[#B8D941] p-6 lg:p-24 flex justify-center lg:justify-end relative">
        <div className="container mx-auto flex flex-col lg:flex-row lg:items-center lg:justify-between ">
          <div className="  lg:w-1/2  mb-6 lg:mb-0 text-center md:text-left " >
            ...
            <h1 className=" title  font-bold mb-4 hidden md:block ms:block  
          ...
          <div className="formulaire w-full  px-8 py-10 mx-auto bg-white shadow-2xl lg:max-w-xl rounded-xl ">
            ...
            <form className="mt-6">
              <div className="flex-1">
                ...
                <input type="text" placeholder="full name" className="flex h-[54px] w-full rounded-full border border-input bg-background px-8 py-2 text-base ring-offset-background  focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 placeholder:text-muted-foreground" style={{ borderColor: "#B8D941" }} />
              </div>
          ...
          <div className="icon grid grid-cols-1 gap-12 md:grid-cols-2 mt-8 ml-24 mx-2">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-gray-700  font-inter tracking-wide" >contact@info.com</p>
              </div>
            </div>
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-gray-700  font-inter tracking-wide" >401 Broadway, 24th floor</p>
                <p className="mt-2 text-sm text-gray-700  font-inter tracking-wide" >Orchard Road, London</p>
              </div>
            </div>
          </div>
        </div>
