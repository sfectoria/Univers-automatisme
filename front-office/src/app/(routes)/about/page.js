  ...
  return (
    ...
    <>
      ...
      <section className=" w-full min-h-screen mb-20">
        <section className="py-12 xl:py-24 h-[84vh] relative flex min-h-full w-full flex-col  place-content-center px-4">
          {/* Patterns */}
          <div className="absolute right-0 hidden min-h-full w-1/4 flex-col justify-center bg-gradient-to-l from-[#b7ebbf] to-[#22c55e] lg:flex">
            {/* right patterns */}
            ...
            {/* Circle */}
            <div className="absolute -left-full aspect-square h-[26rem] rounded-full  bg-[#b7ebbf] lg:-left-1/2">
              {/* pop buttons */}
              ...
              <div className="absolute -top-2 -left-2 flex cursor-pointer flex-col rounded-xl bg-[#22c55e] px-8 py-6 text-center transition hover:-translate-y-1 hover:shadow-md">
              ...
              <div className="absolute bottom-1/4 -right-16 z-10 flex cursor-pointer flex-col rounded-xl bg-white px-10 py-4 text-center transition hover:-translate-y-1 hover:shadow-md xl:-right-1/4">
                <span className="text-5xl font-bold text-[#22c55e]">40%</span>
                <span className="text-base text-[#22c55e]">Market</span>
              </div>
          ...
          <div className="z-10 mx-auto flex w-full max-w-[1080px] flex-col space-y-8">
            ...
            >
              <h1 className="flex max-w-2xl flex-col space-y-1 text-4xl font-bold sm:text-5xl xl:text-7xl text-[#22c55e]">
                {hero_content?.title &&
            ...
            <div className="flex flex-row items-center space-x-10 transition">
                ...
                <button className="group flex flex-row items-center space-x-4">
                  <div className="rounded-full bg-[#22c55e] p-4 group-hover:bg-[#22c55e]/80">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                  ...
                  <span className="font-bold text-[#22c55e]">{hero_content?.play_button}</span>
                </button>
            </div>
              </motion.div>
          </div>
          ...
          <div className="w-full max-w-5xl mx-auto px-4 md:px-6 pt-16 lg:pt-24">
            ...
            <div className='grid md:grid-cols-2 relative z-10  gap-12 '>
              <div className='relative h-[32vh] '>
                <div className=' w-full  md:w-3/4 md:h-auto absolute z-10 inset-0 bg-gradient-to-r from-[#22c55e] to-[#b7ebbf] shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-lg'>
                </div>
                <div className='w-full md:w-3/4 md:h-auto relative z-20 p-6 bg-white md:flex justify-between shadow-lg rounded-lg'>
                  <div className='sm:flex flex-col justify-between space-y-4 py-4 md:pr-6'>
                    <div className='flex justify-between'>
                      <div>
                        <h2 className='text-lg text-[#b7ebbf]'>Our mission</h2>
                        <h1 className='pt-1 text-5xl font-caveat text-[#22c55e]'>Our mission</h1>
              ...
              <div className='relative h-[32vh] '>
                ...
                <div className='w-full md:w-3/4 md:h-auto relative z-20 p-6 bg-white md:flex justify-between shadow-lg rounded-lg'>
                  <div className='sm:flex flex-col justify-between space-y-4 py-4 md:pr-6'>
                    <div className='flex justify-between'>
                      <div>
                        <h2 className='text-lg text-[#b7ebbf]'>Our vision</h2>
                        <h1 className='pt-1 text-5xl font-caveat text-[#22c55e]'>Our vision</h1>
