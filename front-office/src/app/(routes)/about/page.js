    ...
    <>
      ...
      <section className=" w-full min-h-full mb-20 ">
        <section className="head py-12 xl:py-24 h-[84vh] relative flex min-h-full w-full flex-col  place-content-center px-4">
          ...
          <div className=" z-8 mx-11 lg:mx-11 flex w-full max-w-[1080px] flex-col space-y-8">
            ...
            >
              ...
              <p className="content max-w-lg text-lg text-gray-600 xl:max-w-2xl  mt-4 subtitle">
              ...
              <div className="relative aspect-square h-[26rem] rounded-full bg-[#EAF2AE]">
                ...
                <div className="h-full w-full overflow-hidden rounded-full">
                  ...
                  <Image
                    src={picture}
                    alt="Picture of the lady with book"
                    className="scale-[.70] hidden md:block "
                    loading="eager"
        ...
        {/* <section className='  mx-auto  flex flex-col justify-center  overflow-hidden' > */}
        <div className=" max-w-5xl mx-auto px-4 md:px-6 pt-16 lg:pt-24 w-full" data-aos="fade-right">
          ...
          <div className='vision  grid md:grid-cols-2 z-10 md:gap-10 gap-10'>
            <div className='relative h-auto  max-w-[32rem]'> {/* Ajoutez md:ml-auto et max-w-[32rem] ici */}
              ...
              <div className='w-full md:w-[81%] md:h-auto relative z-20 p-6 bg-white md:flex justify-between shadow-lg rounded-lg' >
        ...
        <section className="relative  flex flex-col justify-center  overflow-hidden" data-aos="fade-left">
          <div className="w-full max-w-5xl mx-auto px-4 md:px-6 py-24">
            ...
            <section className="grid gap-20 md:grid-cols-3 md:gap-20">
              ...
              <article className='shadow-xl  rounded-2xl p-6 bg-gradient-to-tr from-primary to-[#EAF2AE]' >
                <div>
        ...
        <section>
          <h2 className="font-PlayfairDisplay section-title  text-center mx-auto" data-aos="fade-right">
            Meet the team
          </h2>

          <div className="px-8  py-16 mx-auto md:px-12 lg:px-32 max-w-7xl" data-aos="fade-right">
            <div className="grid gap-12 lg:grid-cols-3">
              <div>
              <h1
                className='text-[20px] font-caveat uppercase text-primary ' >Know our team</h1>
                <h1
                  className="text-4xl font-semibold tracking-tighter text-primary lg:text-5xl">
                  Meet Our Team
