        ...
        <div className={`container ${isRightPanelActive ? 'right-panel-active' : ''}`} id="container">
          <div className="form-container sign-up-container">
            <form action="#">
              ...
              <button onClick={handleSignUpClickk}>Sign Up</button>
            </form>
          </div>
          ...
          <div className="form-container sign-in-container">
            <form action="#">
              ...
              <button onClick={handleSignInClickk}>Sign In</button>
            </form>
          </div>
          ...
          <div className="overlay-container" >
            <div className="overlay">
              <div className="overlay-panel overlay-left">
                ...
                <p style={{ fontFamily: 'Caveat, cursive' }}>To keep connected with us please login with your personal info</p>
                <button className="ghost" onClick={handleSignInClick} id="signIn">Sign In</button>
              </div>
              <div className="overlay-panel overlay-right">
                <h1 style={{ fontFamily: 'Caveat, cursive' }}>Hello, Friend!</h1>
                <p style={{ fontFamily: 'Caveat, cursive' }}>Enter your personal details and start journey with us</p>
